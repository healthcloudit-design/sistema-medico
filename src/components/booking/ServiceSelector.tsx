...
const CATEGORY_IMAGES: Record<string, string> = {
  ...
  'Consultas':     'https://images.unsplash.com/photo-9TTNQmAV9TQ?w=480&h=360&fit=crop&auto=format',
  'Diagnóstico':   'https://images.unsplash.com/photo-9TTNQmAV9TQ?w=480&h=360&fit=crop&auto=format',
  'Diagnostico':   'https://images.unsplash.com/photo-9TTNQmAV9TQ?w=480&h=360&fit=crop&auto=format',
  'Tratamientos':  'https://images.unsplash.com/photo-QWoJ-e_OQWA?w=480&h=360&fit=crop&auto=format',
  'Procedimientos':'https://images.unsplash.com/photo-9PWGki5WCGs?w=480&h=360&fit=crop&auto=format',
...
const SERVICE_KEYWORD_IMAGES: [string, string][] = [
  ...
  ['fcell',       'https://images.unsplash.com/photo-9PWGki5WCGs?w=160&h=160&fit=crop&auto=format'],
  ['consulta',    'https://images.unsplash.com/photo-9TTNQmAV9TQ?w=160&h=160&fit=crop&auto=format'],
  ['online',      'https://images.unsplash.com/photo-9TTNQmAV9TQ?w=160&h=160&fit=crop&auto=format'],
  // Massage / spa
